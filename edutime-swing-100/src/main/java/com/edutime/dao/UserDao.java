...
public class UserDao{
  public User login(String username,String password) throws SQLException{
    String sql="SELECT id,username,display_name,role,email,active,password FROM users WHERE username=?";
  ...
  public int insert(String u,String p,String n,String r,boolean a,String email) throws SQLException{
    return com.edutime.dao.DaoUtil.update("INSERT INTO users(username,password,display_name,role,email,active) VALUES(?,?,?,?,?,?)", u,p,n,r,email,a?1:0);
  }
